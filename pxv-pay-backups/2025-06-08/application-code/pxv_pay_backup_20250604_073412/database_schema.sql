...
CREATE OR REPLACE FUNCTION "public"."create_user_profile"("user_id" "uuid", "user_email" "text", "user_role" "text" DEFAULT 'registered_user'::"text") RETURNS "json"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  result JSON;
...
ALTER FUNCTION "public"."create_user_profile"("user_id" "uuid", "user_email" "text", "user_role" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_user_profile_simple"("user_id" "uuid", "user_email" "text", "user_role" "text" DEFAULT 'registered_user'::"text") RETURNS "json"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  INSERT INTO public.users (id, email, role, created_at, active)
...
ALTER FUNCTION "public"."create_user_profile_simple"("user_id" "uuid", "user_email" "text", "user_role" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_product_templates_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_product_templates_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."checkout_links" (
    ...
    "checkout_type" "text" DEFAULT 'simple'::"text" NOT NULL,
    "product_name" "text",
    "product_description" "text",
    "product_image_url" "text",
    "product_template_id" "uuid",
    "custom_price" numeric(10,2),
    CONSTRAINT "checkout_links_amount_type_check" CHECK (("amount_type" = ANY (ARRAY['fixed'::"text", 'flexible'::"text"]))),
    CONSTRAINT "checkout_links_checkout_type_check" CHECK (("checkout_type" = ANY (ARRAY['simple'::"text", 'product'::"text"]))),
    CONSTRAINT "checkout_links_product_data_check" CHECK ((("checkout_type" = 'simple'::"text") OR (("checkout_type" = 'product'::"text") AND (("product_template_id" IS NOT NULL) OR ("product_name" IS NOT NULL))))),
...
COMMENT ON COLUMN "public"."checkout_links"."amount_type" IS 'Type of amount: fixed (specific amount) or flexible (customer enters amount within limits)';



COMMENT ON COLUMN "public"."checkout_links"."min_amount" IS 'Minimum amount for flexible checkout links';



COMMENT ON COLUMN "public"."checkout_links"."max_amount" IS 'Maximum amount for flexible checkout links';



COMMENT ON COLUMN "public"."checkout_links"."checkout_type" IS 'Type of checkout: simple (payment collection) or product (product sales)';



COMMENT ON COLUMN "public"."checkout_links"."product_name" IS 'Product name for product checkout type';



COMMENT ON COLUMN "public"."checkout_links"."product_description" IS 'Product description for product checkout type';



COMMENT ON COLUMN "public"."checkout_links"."product_image_url" IS 'Product image URL for product checkout type';



COMMENT ON COLUMN "public"."checkout_links"."product_template_id" IS 'Reference to product template for product checkout type';



COMMENT ON COLUMN "public"."checkout_links"."custom_price" IS 'Custom price override for product checkout (when not using product default price)';
...
COMMENT ON TABLE "public"."countries" IS 'Countries table with support for global (user_id = null) and user-specific data';
...
COMMENT ON TABLE "public"."currencies" IS 'Currencies table with support for global (user_id = null) and user-specific data';
...
CREATE TABLE IF NOT EXISTS "public"."payment_methods" (
    ...
    "country_specific_details" "jsonb" DEFAULT '{}'::"jsonb",
...
CREATE TABLE IF NOT EXISTS "public"."product_templates" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid",
    "product_key" character varying(100) NOT NULL,
    ...
    "category" character varying(50) DEFAULT 'digital'::character varying,
    "tags" "text"[],
    "featured_image" "text",
    "gallery_images" "text"[],
    ...
    CONSTRAINT "product_templates_category_check" CHECK ((("category")::"text" = ANY ((ARRAY['digital'::character varying, 'physical'::character varying, 'service'::character varying, 'subscription'::character varying, 'donation'::character varying])::"text"[]))),
    CONSTRAINT "product_templates_pricing_type_check" CHECK ((("pricing_type")::"text" = ANY ((ARRAY['fixed'::character varying, 'flexible'::character varying, 'tiered'::character varying])::"text"[])))
);
...
ALTER TABLE ONLY "public"."product_templates"
    ADD CONSTRAINT "product_templates_user_id_product_key_key" UNIQUE ("user_id", "product_key");
...
CREATE INDEX "countries_currency_idx" ON "public"."countries" USING "btree" ("currency_code");



CREATE INDEX "countries_global_data_idx" ON "public"."countries" USING "btree" ("user_id") WHERE ("user_id" IS NULL);



CREATE INDEX "countries_global_idx" ON "public"."countries" USING "btree" ("code") WHERE ("user_id" IS NULL);
...
CREATE INDEX "currencies_global_data_idx" ON "public"."currencies" USING "btree" ("user_id") WHERE ("user_id" IS NULL);



CREATE INDEX "currencies_global_idx" ON "public"."currencies" USING "btree" ("code") WHERE ("user_id" IS NULL);
...
CREATE INDEX "idx_checkout_links_amount_type" ON "public"."checkout_links" USING "btree" ("amount_type");



CREATE INDEX "idx_checkout_links_checkout_type" ON "public"."checkout_links" USING "btree" ("checkout_type");
...
CREATE INDEX "idx_checkout_links_product_template_id" ON "public"."checkout_links" USING "btree" ("product_template_id");
...
CREATE INDEX "idx_payment_methods_country_specific_details" ON "public"."payment_methods" USING "gin" ("country_specific_details");



CREATE INDEX "idx_product_templates_category" ON "public"."product_templates" USING "btree" ("category");



CREATE INDEX "idx_product_templates_created_at" ON "public"."product_templates" USING "btree" ("created_at");



CREATE INDEX "idx_product_templates_is_active" ON "public"."product_templates" USING "btree" ("is_active");



CREATE INDEX "idx_product_templates_is_featured" ON "public"."product_templates" USING "btree" ("is_featured");



CREATE INDEX "idx_product_templates_user_id" ON "public"."product_templates" USING "btree" ("user_id");
...
CREATE OR REPLACE TRIGGER "trigger_update_product_templates_updated_at" BEFORE UPDATE ON "public"."product_templates" FOR EACH ROW EXECUTE FUNCTION "public"."update_product_templates_updated_at"();
...
ALTER TABLE ONLY "public"."checkout_links"
    ADD CONSTRAINT "checkout_links_product_template_id_fkey" FOREIGN KEY ("product_template_id") REFERENCES "public"."product_templates"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."product_templates"
    ADD CONSTRAINT "product_templates_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Public can view active product templates" ON "public"."product_templates" FOR SELECT USING (("is_active" = true));



COMMENT ON POLICY "Public can view active product templates" ON "public"."product_templates" IS 'Allows public/anonymous access to active product templates for checkout page display';
...
CREATE POLICY "Super admins can create checkout links" ON "public"."checkout_links" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));



CREATE POLICY "Super admins can create checkout settings" ON "public"."merchant_checkout_settings" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));



CREATE POLICY "Super admins can delete checkout links" ON "public"."checkout_links" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));



CREATE POLICY "Super admins can delete checkout settings" ON "public"."merchant_checkout_settings" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));
...
CREATE POLICY "Super admins can update checkout links" ON "public"."checkout_links" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));



CREATE POLICY "Super admins can update checkout settings" ON "public"."merchant_checkout_settings" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));



CREATE POLICY "Super admins can view all checkout links" ON "public"."checkout_links" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));



CREATE POLICY "Super admins can view all checkout settings" ON "public"."merchant_checkout_settings" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role")))));
...
CREATE POLICY "Users can create their own product templates" ON "public"."product_templates" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can delete their own product templates" ON "public"."product_templates" FOR DELETE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can manage their countries" ON "public"."countries" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can manage their currencies" ON "public"."currencies" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can manage their payment methods" ON "public"."payment_methods" USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can manage their payments" ON "public"."payments" USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can update their own product templates" ON "public"."product_templates" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their countries" ON "public"."countries" FOR SELECT USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can view their currencies" ON "public"."currencies" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can view their own product templates" ON "public"."product_templates" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view their payment methods" ON "public"."payment_methods" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "countries_delete_policy" ON "public"."countries" FOR DELETE USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "countries_insert_policy" ON "public"."countries" FOR INSERT WITH CHECK ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));



CREATE POLICY "countries_select_own_or_global" ON "public"."countries" FOR SELECT USING ((("auth"."uid"() = "user_id") OR ("user_id" IS NULL)));



CREATE POLICY "countries_select_policy" ON "public"."countries" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "countries_update_policy" ON "public"."countries" FOR UPDATE USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "currencies_delete_policy" ON "public"."currencies" FOR DELETE USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "currencies_insert_policy" ON "public"."currencies" FOR INSERT WITH CHECK ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));



CREATE POLICY "currencies_select_own_or_global" ON "public"."currencies" FOR SELECT USING ((("auth"."uid"() = "user_id") OR ("user_id" IS NULL)));



CREATE POLICY "currencies_select_policy" ON "public"."currencies" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "currencies_update_policy" ON "public"."currencies" FOR UPDATE USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "payment_methods_delete_policy" ON "public"."payment_methods" FOR DELETE USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "payment_methods_insert_policy" ON "public"."payment_methods" FOR INSERT WITH CHECK ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "payment_methods_select_policy" ON "public"."payment_methods" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "payment_methods_update_policy" ON "public"."payment_methods" FOR UPDATE USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "payments_insert_policy" ON "public"."payments" FOR INSERT WITH CHECK ((("user_id" = "auth"."uid"()) OR ("merchant_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "payments_select_policy" ON "public"."payments" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR ("merchant_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "payments_update_policy" ON "public"."payments" FOR UPDATE USING ((("user_id" = "auth"."uid"()) OR ("merchant_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'super_admin'::"public"."user_role"))))));
...
CREATE POLICY "service_role_global_countries" ON "public"."countries" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "service_role_global_currencies" ON "public"."currencies" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "service_role_payments_insert" ON "public"."payments" FOR INSERT TO "service_role" WITH CHECK (true);
...
CREATE POLICY "service_role_payments_select" ON "public"."payments" FOR SELECT TO "service_role" USING (true);
...
CREATE POLICY "service_role_payments_update" ON "public"."payments" FOR UPDATE TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "users_update_policy" ON "public"."users" FOR UPDATE TO "authenticated" USING ((("auth"."uid"() = "id") OR ("auth"."email"() = ANY (ARRAY['admin@pxvpay.com'::"text", 'dev-admin@pxvpay.com'::"text", 'superadmin@pxvpay.com'::"text"]))));
...
GRANT ALL ON FUNCTION "public"."create_user_profile"("user_id" "uuid", "user_email" "text", "user_role" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_user_profile"("user_id" "uuid", "user_email" "text", "user_role" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_user_profile"("user_id" "uuid", "user_email" "text", "user_role" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_user_profile_simple"("user_id" "uuid", "user_email" "text", "user_role" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_user_profile_simple"("user_id" "uuid", "user_email" "text", "user_role" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_user_profile_simple"("user_id" "uuid", "user_email" "text", "user_role" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_product_templates_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_product_templates_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_product_templates_updated_at"() TO "service_role";
