...
-- Create sample data for testing (uncomment if needed for local development)
/*
-- Insert a super admin user if one doesn't exist
INSERT INTO public.users (id, email, role)
SELECT '00000000-0000-0000-0000-000000000000', 'admin@example.com', 'super_admin'
WHERE NOT EXISTS (SELECT 1 FROM public.users WHERE role = 'super_admin');

-- Insert some sample payments
INSERT INTO public.payments (amount, payment_method, status, user_id)
VALUES 
  ('500.00', 'Bank Transfer', 'completed', '00000000-0000-0000-0000-000000000000'),
  ('350.00', 'Mobile Money', 'pending', '00000000-0000-0000-0000-000000000000'),
  ('1200.00', 'Crypto', 'completed', '00000000-0000-0000-0000-000000000000'),
  ('341.00', 'Bank Transfer', 'pending', '00000000-0000-0000-0000-000000000000');
*/ 