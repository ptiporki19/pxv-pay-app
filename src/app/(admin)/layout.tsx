...
const merchantNavItems = [
  ...
  { label: 'Manual Payment Methods', path: '/payment-methods', iconName: 'CreditCard' },
  { label: 'Payment Link', path: '/payment-link', iconName: 'Link2' },
...
export default async function MerchantDashboardLayout({
  ...
  const userRole = profile?.role || 'registered_user'
