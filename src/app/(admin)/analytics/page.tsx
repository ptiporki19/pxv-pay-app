  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        <h1 className="text-4xl lg:text-5xl font-black tracking-tight leading-tight text-gray-900 dark:text-white font-geist">Dashboard</h1>
        <div className="flex items-center justify-between">
          <p className="text-lg lg:text-xl font-medium text-gray-600 dark:text-gray-300 leading-relaxed font-geist">
          ...
          <div className="flex items-center gap-2">
            <Button className="gap-2 font-bold violet-gradient hover:violet-gradient-hover font-geist px-6 py-2" asChild>
              <Link href="/checkout/create">
                <Plus className="h-4 w-4" />
                Create Checkout Link
              </Link>
            </Button>
            <Button variant="outline" className="gap-2 font-bold font-geist px-6 py-2 relative" asChild>
